...
Conceptos de las Clases 1-4:

- Modelo cliente-servidor y cómo funciona la web
- Estructura HTML y etiquetas semánticas
- CSS: selectores, box model, paleta de colores
- Flexbox básico

...
### Prepara tu Presentación (3 minutos)

Tu presentación debe cubrir:

| Sección | Tiempo | Qué mostrar |
|---------|--------|-------------|
| **Demo** | 1 min | Juega una ronda en vivo. Muestra pistas, historial, reinicio |
| **Código** | 1 min | Muestra 1-2 funciones clave y explica qué hacen |
| **Reflexión** | 1 min | ¿Qué aprendiste? ¿Qué fue lo más difícil? ¿Qué mejorarías? |

### Checklist Pre-Presentación

- [ ] El juego funciona sin errores
- [ ] Sabes explicar qué hace `verificarIntento()`
- [ ] Sabes explicar qué hace `addEventListener`
- [ ] Practicaste la presentación al menos una vez
